...
@FacesConverter(value = "atributosConverter")
public class AtributosConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Atributos) {
            Atributos o = (Atributos) object;
            return getStringKey(o.getId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Atributos.class.getName()});
            return null;
        }
    }
